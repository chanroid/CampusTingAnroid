...
public class UserEx implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -578979997332087264L;
	...
	public UserEx(String userId, String schoolId, String deptId, String studentNum, String userLoginId, String loginTypeId, String pw, String mobileId, String mobileType,
			...
			String mainPicture, String personalityId1, String personalityId2, String personalityId3, String idealType, String appeal, String confirm, String judge, String cityId) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "User [userId=" + userId + ", schoolId=" + schoolId + ", deptId=" + deptId + ", studentNum=" + studentNum + ", userLoginId=" + userLoginId + ", loginTypeId="
				...
				+ lastConnection + ", mainPicture=" + mainPicture + ", personalityId1=" + personalityId1 + ", personalityId2=" + personalityId2 + ", personalityId3="
				+ personalityId3 + ", idealType=" + idealType + ", appeal=" + appeal + ", confirm=" + confirm + ", judge=" + judge + ", cityId=" + cityId + "]";
	}
